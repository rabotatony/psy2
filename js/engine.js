...
const TIMBRES={
 ...
 plucky:[0,1,.5,.7,.3,.5,.2,.35,.15,.25,.1,.15],
 bell:[0,1,.2,.6,.1,.5,.3,.4,.1,.3,.2,.25],
 airy:[0,1,.3,.2,.5,.15,.4,.1,.3,.2,.25,.15],
 dark:[0,1,.6,.4,.5,.3,.4,.25,.3,.2,.25,.15,.2,.1],
 square:[0,1,0,.5,0,.4,0,.33,0,.28,0,.24,0,.2],
};
export const eng={
 ctx:null, st:null,
 bind(st){this.st=st;},
